...
class Home extends Component<{}, State> {
  ...
  findTopPosition = (element) => {
    return this.state.theposition + document.getElementById(element).offsetTop;
  };
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Contact client={this.state.client} isMobile={this.state.isMobile} />
        </div>
